...
class configClass:
    def __init__(self):
        self.experiment_name = '680_IDs_easy_hard'
        self.results_dir = f"results/{self.experiment_name}"
        self.checkpoints_dir = "easy_hard"
        self.img_dir = "../New Annotation/Matches_e_d_three_ROI_images"
        self.annot_dir = "../New Annotation/Matches_e_d_three_ROI_annotations"
        self.width = 512
        self.height = 512
