...
from configs.config_hard_easy import configClass
...
if __name__ == "__main__":
    ...
    trainer = pl.Trainer(limit_train_batches=cfg.limit_train_batches,
                         max_epochs=int(cfg.max_epoch * 0.40),
                         accelerator="gpu",
    ...
    # Resume the training process with easy set
    ...
    trainer = pl.Trainer(limit_train_batches=cfg.limit_train_batches,
                         max_epochs=int(cfg.max_epoch * 0.70),
                         accelerator="gpu",
                         devices=cfg.cuda_devices,
                         log_every_n_steps=25,
                         default_root_dir=cfg.checkpoints_dir,
    ...
    trainer.fit(model=classifier, 
                train_dataloaders=dl_train_easy, 
                val_dataloaders=dl_valid, 
    ...
    trainer = pl.Trainer(limit_train_batches=cfg.limit_train_batches,
                         max_epochs=int(cfg.max_epoch*1.2),
                         accelerator="gpu",
                         devices=cfg.cuda_devices,
                         log_every_n_steps=25,
                         default_root_dir=cfg.checkpoints_dir,
