...
if torch.cuda.is_available():
    ...
    model.load_state_dict(torch.load('./trained_models/verification_approach_final_model_IFACTS.pth', map_location='cpu'))
...
plt.title('ROC Curve')
plt.legend()
plt.savefig(f'./archive/trained_model_ROC_curve_{experiment_name}.png')



# Write out the prediction file for later visualization. 
pairs = np.loadtxt(pair_file, dtype=str)
with open(f"./archive/trained_model_ROC_curve_{experiment_name}.csv", "w") as fp:
