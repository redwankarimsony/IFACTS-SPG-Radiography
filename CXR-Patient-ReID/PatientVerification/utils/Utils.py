...
def get_data_loaders(phase='training', data_handling='balanced', n_channels=3, n_samples=100000, transform=None,
    ...
    ## __________________Commented from the old code______________
...
def train(net, training_loader, n_samples, batch_size, criterion, optimizer, epoch, n_epochs, device):
    net.train()
    running_loss = 0.0
...
def validate(net, validation_loader, n_samples, batch_size, criterion, epoch, n_epochs, device):
    net.eval()
    running_loss = 0
